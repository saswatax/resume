...
\begin{itemize}
  \item Led the development of omnienenge.co and chatbotbuilder.net, creating both platforms from the ground up, including all backend systems, API structure, and database schemas.
